...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        "group/navigation-menu relative max-w-none flex-1 items-center",
        className
      )}
      {...props}
    >
...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        "group w-full flex flex-1 list-none items-center justify-between gap-1",
        className,
      )}
      {...props}
    />
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-full justify-center rounded-md bg-card px-4 py-2 text-[1rem] leading-6 font-medium disabled:pointer-events-none disabled:opacity-50 focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1",
);
